...
@section('content')
    ...
    <br>
    <button type="button" class="btn btn-success" onclick="location.href = '{{ route('bancos.create') }}'">
    ...
    role="grid" aria-describedby="example1_info" >
            ...
            <tr role="row">
                <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Motor de renderizado: actívelo para ordenar la columna descendente">
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">Nombre de Banco</font>
                    </font>
                </th>
        ...
        <tbody>
            <tr role="row" class="old">
                <td tabindex="0" class="">
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">{{$banco->nombre}}</font>
                    </font>
                </td>
                <td tabindex="0" class="">
