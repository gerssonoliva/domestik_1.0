    ...
    role="grid" aria-describedby="example1_info" >
        ...
        <tbody>
            <tr role="row" class="old">
                ...
                <td tabindex="0" class="">
                    <button type="button" class="btn btn-primary btn-sm" onclick="location.href='{{route('proveedores.edit', $proveedor->id)}}'">
                        <font style="vertical-align: inherit;">
                ...
                <td tabindex="0" class="">
                    <button type="button" class="btn btn-info btn-sm" onclick="location.href='{{route('proveedores.edit', $proveedor->id)}}'">
                        <font style="vertical-align: inherit;">
