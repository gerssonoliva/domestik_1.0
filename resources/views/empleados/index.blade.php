    ...
    role="grid" aria-describedby="example1_info" >
        ...
        <tbody>
            <tr role="row" class="old">
                ...
                <td tabindex="0" class="">
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">{{$empleado->nombre}}</font>
                    </font>
                </td>
                <td tabindex="0" class="">
                    <font style="vertical-align: inherit;">
                ...
                <td tabindex="0" class="">
                    <button type="button" class="btn btn-primary btn-sm" onclick="location.href='{{route('empleados.edit', $empleado->id)}}'">
                        <font style="vertical-align: inherit;">
                            ...
                            <!-- Colocar letras en el botón
                            <font style="vertical-align: inherit;"></font>-->
                        </font>
                    </button>
                </td>
                <td tabindex="0" class="">
                    <button type="button" class="btn btn-info btn-sm" onclick="location.href='{{route('empleados.edit', $empleado->id)}}'">
                        <font style="vertical-align: inherit;">
